...
public class Pelanggan extends javax.swing.JFrame {
    ...
    public void load_data() {
        try {
            ...
            Object header[] = {"ID PELANGGAN", "NAMA", "ALAMAT", "TELEPON"};
    ...
    if (selectedRowIndex >= 0) {
        ...
        String telepon = model.getValueAt(selectedRowIndex, 3).toString();
    ...
    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
        ...
        try {
            Connection kon = koneksi.koneksiDb();
            Statement st = kon.createStatement();
            String sql = "INSERT INTO pelanggan (id_pelanggan, nama, alamat, telepon) VALUES ('" + id_pelanggan + "', '" + nama + "', '" + alamat + "', '" + telepon + "')";
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try {
            Connection kon = koneksi.koneksiDb();
            Statement st = kon.createStatement();
            String sql = "UPDATE pelanggan SET nama='" + nama + "', alamat='" + alamat + "', telepon='" + telepon + "' WHERE id_pelanggan='" + id_pelanggan + "'";
        ...
        private void clearFields() {
            ...
            jTextField4.setText(""); // Kosongkan Telepon
