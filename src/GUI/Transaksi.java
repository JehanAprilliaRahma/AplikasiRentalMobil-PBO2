...
public class Transaksi extends javax.swing.JFrame {
    ...
    public void load_data() {
        try {
            ...
            Object header[] = {"ID TRANSAKSI", "ID PELANGGAN", "ID MOBIL", "TANGGAL SEWA", "TANGGAL KEMBALI", "TOTAL BAYAR"};
    ...
    private void loadComboBoxData() {
        try {
        Connection kon = koneksi.koneksiDb();
        String sql_pelanggan = "SELECT id_pelanggan FROM pelanggan";
        String sql_mobil = "SELECT id_mobil FROM mobil";

        Statement st1 = kon.createStatement();
        Statement st2 = kon.createStatement();
        ResultSet rsPelanggan = st1.executeQuery(sql_pelanggan);
        ResultSet rsMobil = st2.executeQuery(sql_mobil);

        while (rsPelanggan.next()) {
            jComboBox1.addItem(rsPelanggan.getString("id_pelanggan"));
        }

        while (rsMobil.next()) {
            jComboBox2.addItem(rsMobil.getString("id_mobil"));
        }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 970, 140));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -3, 970, 140));
        ...
        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 130, 200, 440));
        ...
        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 180, 740, 250));
        ...
        jPanel2.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 30, -1, -1));
        ...
        jPanel2.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 30, 190, -1));
        ...
        jPanel2.add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 30, 190, -1));
        jPanel2.add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 80, 190, -1));
        jPanel2.add(jTextField6, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 130, 190, -1));

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { " " }));
        jPanel2.add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 80, 200, -1));

        jPanel2.add(jComboBox2, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 130, 200, -1));

        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 130, 770, 440));
    ...
    if (selectedRowIndex >= 0) {
        ...
        String id_mobil = model.getValueAt(selectedRowIndex, 2).toString();
        String tanggal_sewa = model.getValueAt(selectedRowIndex, 3).toString();
        String tanggal_kembali = model.getValueAt(selectedRowIndex, 4).toString();
        String total_bayar = model.getValueAt(selectedRowIndex, 5).toString();
        ...
        jComboBox2.setSelectedItem(id_mobil);
        jTextField4.setText(tanggal_sewa);
        jTextField5.setText(tanggal_kembali);
        jTextField6.setText(total_bayar);
    }
    ...
    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
        ...
        String id_pelanggan = jComboBox1.getSelectedItem().toString();
        String id_mobil = jComboBox2.getSelectedItem().toString();
        String tanggal_sewa = jTextField4.getText();
        String tanggal_kembali = jTextField5.getText();
        String total_bayar = jTextField6.getText();

    try {
        Connection kon = koneksi.koneksiDb();
        Statement st = kon.createStatement();
        String sql = "INSERT INTO transaksi (id_transaksi, id_pelanggan, id_mobil, tanggal_sewa, tanggal_kembali, total_bayar) VALUES ('" + id_transaksi + "', '" + id_pelanggan + "', '" + id_mobil + "', '" + tanggal_sewa + "', '" + tanggal_kembali + "', '" + total_bayar + "')";
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try {
            Connection kon = koneksi.koneksiDb();
            Statement st = kon.createStatement();
            String sql = "UPDATE transaksi SET id_pelanggan='" + id_pelanggan + "', id_mobil='" + id_mobil + "', tanggal_sewa='" + tanggal_sewa + "', tanggal_kembali='" + tanggal_kembali + "', total_bayar='" + total_bayar + "' WHERE id_transaksi='" + id_transaksi + "'";
        ...
        private void clearFields() {
            ...
            jComboBox1.setSelectedIndex(0); // Atur indeks pilihan ke 0 pada JComboBox ID Pelanggan
            jComboBox2.setSelectedIndex(0); // Atur indeks pilihan ke 0 pada JComboBox ID Mobil
            jTextField4.setText(""); // Kosongkan tanggal_sewa
            jTextField5.setText(""); // Kosongkan tanggal_kembali
            jTextField6.setText(""); // Kosongkan total_bayar
